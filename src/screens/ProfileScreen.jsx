...
const TABS = [
  ...
  { id: 'elevenlabs', label: 'ElevenLabs', Icon: IcoStar,    color: Colors.liturgical.gold, premium: true },
...
function AvatarPlaceholder({ size = 76, accentColor, badgeBg = Colors.surface.primary }) {
  ...
  return (
    <View style={{ width: size, height: size }}>
      ...
      >
        <Svg width={badgeSize * 0.58} height={badgeSize * 0.58} viewBox="0 0 24 24" fill="none">
          <Path
...
function IcoMoon({ c, size = 16 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M21 12.79A9 9 0 1 1 11.21 3a7 7 0 1 0 9.79 9.79Z" stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
...
function IcoAuto({ c, size = 16 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Path d="M12 3v9l5 3" stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
function IcoMic({ c, size = 16 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Path d="M5 10a7 7 0 0 0 14 0M12 19v3M8 22h8" stroke={c} strokeWidth={1.8} strokeLinecap="round" />
    </Svg>
  );
}
function IcoWave({ c, size = 16 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M2 12h2M6 8v8M10 5v14M14 9v6M18 7v10M22 12h-2" stroke={c} strokeWidth={1.8} strokeLinecap="round" />
    </Svg>
  );
}
function IcoBell({ c, size = 16 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9M13.73 21a2 2 0 0 1-3.46 0" stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
function IcoInfo({ c, size = 16 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Line x1="12" y1="8" x2="12" y2="8.5" stroke={c} strokeWidth={2.2} strokeLinecap="round" />
...
function IcoPower({ c, size = 16 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M18.36 6.64a9 9 0 1 1-12.73 0M12 2v10" stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
function IcoCheck({ c, size = 16 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Polyline points="20 6 9 17 4 12" stroke={c} strokeWidth={2.2} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
...
function IcoKey({ c, size = 16 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0 3 3L22 7l-3-3m-3.5 3.5L19 4" stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
...
function IcoLink({ c, size = 16 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
function IcoSliders({ c, size = 20 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Line x1="4" y1="21" x2="4" y2="14" stroke={c} strokeWidth={1.8} strokeLinecap="round" />
      <Line x1="4" y1="10" x2="4" y2="3" stroke={c} strokeWidth={1.8} strokeLinecap="round" />
      <Line x1="12" y1="21" x2="12" y2="12" stroke={c} strokeWidth={1.8} strokeLinecap="round" />
      <Line x1="12" y1="8" x2="12" y2="3" stroke={c} strokeWidth={1.8} strokeLinecap="round" />
      <Line x1="20" y1="21" x2="20" y2="16" stroke={c} strokeWidth={1.8} strokeLinecap="round" />
      <Line x1="20" y1="12" x2="20" y2="3" stroke={c} strokeWidth={1.8} strokeLinecap="round" />
      <Line x1="1" y1="14" x2="7" y2="14" stroke={c} strokeWidth={1.8} strokeLinecap="round" />
      <Line x1="9" y1="8" x2="15" y2="8" stroke={c} strokeWidth={1.8} strokeLinecap="round" />
      <Line x1="17" y1="16" x2="23" y2="16" stroke={c} strokeWidth={1.8} strokeLinecap="round" />
    </Svg>
  );
}
function IcoGear({ c, size = 20 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
...
function IcoRepeat({ c, size = 16 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M17 1l4 4-4 4" stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M3 11V9a4 4 0 0 1 4-4h14" stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M7 23l-4-4 4-4" stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
...
function IcoBookOpen({ c, size = 16 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
function IcoCalGrid({ c, size = 16 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Line x1="3" y1="10" x2="21" y2="10" stroke={c} strokeWidth={1.8} strokeLinecap="round" />
    </Svg>
  );
}
...
export default function ProfileScreen() {
  ...
  useEffect(() => {
    loadVoices();
    try {
      if (ttsVoiceId) _Tts().setDefaultVoice(ttsVoiceId).catch(() => {});
    } catch (_) {}
  ...
  return (
    ...
    >
      ...
      <View style={[s.hero, { backgroundColor: surface }]}>
        ...
        {/* Avatar — preparado para image upload */}
        <TouchableOpacity
          activeOpacity={0.85}
          onPress={() => {/* TODO: image picker */}}
          style={[s.avatar, { borderColor: Colors.brand.primary + '30' }]}
        >
          <AvatarPlaceholder size={76} accentColor={Colors.brand.primary} badgeBg={surface} />
        </TouchableOpacity>

        <Text style={[s.heroPhone, { color: ink }]}>{phone || '+502 0000-0000'}</Text>

        <View style={[s.heroBadge, { backgroundColor: seasonColor + '18', borderColor: seasonColor + '40' }]}>
          ...
          {TABS.map((tab) => {
            ...
            return (
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <View style={[s.tabIconWrap, active && { backgroundColor: tab.color + '22' }]}>
                  <tab.Icon c={accentColor} size={20} />
                  {isPremium && (
                    <View style={[s.tabPremiumDot, { backgroundColor: hasEleven ? Colors.liturgical.green : Colors.liturgical.gold }]} />
                  )}
                </View>
                <Text style={[s.tabText, { color: accentColor }, active && s.tabTextActive]}>
                  {tab.label}
                </Text>
              </TouchableOpacity>
            );
      ...
      <View style={s.tabContent}>
        {activeTab === 'apariencia' && <TabApariencia darkMode={darkMode} setDarkMode={setDarkMode} ctx={ctx} />}
        {activeTab === 'voz'        && <TabVoz ttsVoiceId={ttsVoiceId} setTtsVoiceId={setTtsVoiceId} ttsSpeed={ttsSpeed} setTtsSpeed={setTtsSpeed} systemVoices={systemVoices} voiceOpen={voiceOpen} setVoiceOpen={setVoiceOpen} voicesLoading={voicesLoading} loadVoices={loadVoices} onGoEleven={() => setActiveTab('elevenlabs')} ctx={ctx} />}
        {activeTab === 'elevenlabs' && <TabElevenLabs elevenlabsApiKey={elevenlabsApiKey} setElevenlabsApiKey={setElevenlabsApiKey} elevenlabsVoiceId={elevenlabsVoiceId} setElevenlabsVoiceId={setElevenlabsVoiceId} showApiKey={showApiKey} setShowApiKey={setShowApiKey} hasEleven={hasEleven} ctx={ctx} />}
        {activeTab === 'app'        && <TabApp dailyReminder={dailyReminder} setDailyReminder={setDailyReminder} onLogout={handleLogout} ctx={ctx} />}
      </View>
    </ScrollView>
  );
}
        ...
        {OPTS.map((opt) => {
          ...
          return (
            ...
            >
              ...
              <Text style={[t.themeLabel, { color: active ? Colors.brand.primary : ink }]}>{opt.label}</Text>
...
function TabVoz({
  ttsVoiceId, setTtsVoiceId, ttsSpeed, setTtsSpeed,
  systemVoices, voiceOpen, setVoiceOpen, voicesLoading, loadVoices,
  onGoEleven, ctx,
}) {
  const { ink, muted, border, surface } = ctx;
  const selectedName = systemVoices.find((v) => v.id === ttsVoiceId)?.name ?? 'Por defecto';
    ...
    <View style={t.section}>
      ...
      <View style={[t.card, { backgroundColor: surface, borderColor: border }]}>
        <TouchableOpacity
          ...
          activeOpacity={0.7}
          style={[t.row, { borderBottomWidth: voiceOpen ? 0.5 : 0, borderBottomColor: border }]}
        >
          <View style={[t.iconWrap, { backgroundColor: '#30D15820' }]}>
            <IcoMic c="#30D158" size={17} />
          </View>
          <Text style={[t.rowLabel, { color: ink }]}>Voz activa</Text>
          <Text style={[t.rowVal, { color: muted }]} numberOfLines={1}>{selectedName}</Text>
            ...
            {voicesLoading ? (
              ...
              <View style={t.emptyBox}>
                ...
                <Text style={[t.emptyText, { color: muted }]}>
                  Instálalas desde Configuración {'›'} Accesibilidad {'›'} Contenido hablado {'›'} Voces {'›'} Español
                </Text>
                <TouchableOpacity onPress={loadVoices} style={[t.retryBtn, { borderColor: Colors.brand.primary + '50' }]}>
                  <Text style={{ color: Colors.brand.primary, fontSize: 13, fontWeight: '600' }}>Reintentar</Text>
                </TouchableOpacity>
              </View>
            ) : (
              [{ id: null, name: 'Por defecto', language: '' }, ...systemVoices].map((v, i, arr) => {
                const sel = v.id === ttsVoiceId || (v.id === null && ttsVoiceId === null);
                return (
                  <TouchableOpacity
                    key={v.id ?? '__default'}
                    onPress={() => {
                      setTtsVoiceId(v.id);
                      if (v.id) try { _Tts().setDefaultVoice(v.id); } catch (_) {}
                      setVoiceOpen(false);
                    }}
                    style={[
                      t.voiceItem,
                      i < arr.length - 1 && { borderBottomWidth: 0.5, borderBottomColor: border },
                      sel && { backgroundColor: Colors.brand.primary + '08' },
                    ]}
                    activeOpacity={0.6}
                  >
                    <View style={{ flex: 1 }}>
                      <Text style={[t.voiceName, { color: sel ? Colors.brand.primary : ink }]}>{v.name}</Text>
                      {v.language ? <Text style={[t.voiceLang, { color: muted }]}>{v.language}</Text> : null}
                    </View>
      ...
      <TouchableOpacity
        onPress={onGoEleven}
        activeOpacity={0.8}
        style={[t.promoCard, { borderColor: Colors.liturgical.gold + '60', backgroundColor: Colors.liturgical.gold + '0D' }]}
      >
        <IcoStar c={Colors.liturgical.gold} size={16} />
        <View style={{ flex: 1 }}>
          <Text style={[t.promoTitle, { color: ink }]}>¿Quieres una voz más natural?</Text>
          <Text style={[t.promoSub, { color: muted }]}>Activa ElevenLabs para síntesis de voz IA de alta calidad.</Text>
        </View>
...
function TabElevenLabs({
  ...
  return (
    <View style={t.section}>
      ...
      {/* Banner premium */}
      <View style={[t.premiumBanner, { borderColor: Colors.liturgical.gold + '70', backgroundColor: Colors.liturgical.gold + '12' }]}>
        <View style={t.premiumBannerTop}>
          <View style={[t.premiumIconWrap, { backgroundColor: Colors.liturgical.gold + '25' }]}>
          ...
          <View style={{ flex: 1 }}>
            <View style={t.premiumTitleRow}>
              ...
              <View style={[t.recommendedPill, { backgroundColor: Colors.liturgical.gold + '22', borderColor: Colors.liturgical.gold + '50' }]}>
                <Text style={[t.recommendedText, { color: Colors.liturgical.gold }]}>RECOMENDADO</Text>
              </View>
            </View>
            <Text style={[t.premiumSub, { color: muted }]}>Síntesis de voz de alta calidad con entonación natural para el español.</Text>
          </View>
        </View>

        <View style={[t.compareDivider, { backgroundColor: Colors.liturgical.gold + '30' }]} />
        ...
        <View style={t.compareRow}>
          <CompareCol
            ...
            ink={ink} muted={muted}
          />
          <View style={[t.compareCenter, { backgroundColor: Colors.liturgical.gold + '30' }]} />
          <CompareCol
            title="ElevenLabs"
      ...
      {/* Estado actual */}
      {hasEleven && (
        <View style={[t.activeCard, { backgroundColor: Colors.liturgical.green + '10', borderColor: Colors.liturgical.green + '40' }]}>
          <IcoCheck c={Colors.liturgical.green} size={16} />
          <Text style={[t.activeText, { color: Colors.liturgical.green }]}>ElevenLabs activo</Text>
        </View>
      )}
      ...
      <View style={[t.card, { backgroundColor: surface, borderColor: border }]}>
        {ELEVEN_STEPS.map((step, i) => (
          <View
            key={step.n}
            style={[t.stepRow, i < ELEVEN_STEPS.length - 1 && { borderBottomWidth: 0.5, borderBottomColor: border }]}
          >
            <View style={[t.stepNum, { backgroundColor: Colors.brand.primary + '15' }]}>
              <Text style={[t.stepNumText, { color: Colors.brand.primary }]}>{step.n}</Text>
            </View>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
          style={[t.linkBtn, { backgroundColor: Colors.brand.primary + '10', borderTopColor: border }]}
        >
          <IcoLink c={Colors.brand.primary} size={16} />
          <Text style={[t.linkBtnText, { color: Colors.brand.primary }]}>Abrir elevenlabs.io</Text>
      ...
      <Text style={[t.hint, { color: muted }]}>
        El Voice ID es el identificador de la voz que deseas usar. Encuéntralo en la sección de voces dentro de tu cuenta ElevenLabs.
      </Text>
...
function CompareCol({ title, items, bad, ink, muted }) {
  return (
    <View style={t.compareCol}>
      <Text style={[t.compareTitle, { color: bad ? muted : Colors.liturgical.green }]}>{title}</Text>
      {items.map((item) => (
        <View key={item} style={t.compareItem}>
          <Text style={{ color: bad ? Colors.liturgical.red : Colors.liturgical.green, fontSize: 13 }}>
            {bad ? '✕' : '✓'}
          </Text>
...
function TabApp({ dailyReminder, setDailyReminder, onLogout, ctx }) {
  ...
  const seasonColor = Colors.liturgical[TODAY.seasonColor] ?? Colors.liturgical.green;
  const ABOUT = [
    { label: 'Versión',         value: '1.0.0',                        Icon: IcoInfo,     iconBg: '#0A84FF18', iconC: '#0A84FF' },
    { label: 'Ciclo litúrgico', value: CYCLE.label,                    Icon: IcoRepeat,   iconBg: seasonColor + '22', iconC: seasonColor },
    { label: 'Año litúrgico',   value: String(CYCLE.liturgicalYear),   Icon: IcoCalGrid,  iconBg: Colors.brand.primary + '18', iconC: Colors.brand.primary },
    { label: 'Lecturas',        value: 'dominicos.org · Vatican News', Icon: IcoBookOpen, iconBg: '#FF6B3518', iconC: '#FF6B35' },
    { label: 'Calendario',      value: 'Rito Romano',                  Icon: IcoCalGrid,  iconBg: '#5E5CE618', iconC: '#5E5CE6' },
  ];
    ...
    <View style={t.section}>
      ...
      <View style={[t.card, { backgroundColor: surface, borderColor: border }]}>
        {ABOUT.map((row, i) => (
          <View
            key={row.label}
            style={[t.row, i < ABOUT.length - 1 && { borderBottomWidth: 0.5, borderBottomColor: border }]}
          >
      ...
      <View style={[t.card, { backgroundColor: surface, borderColor: border }]}>
        <TouchableOpacity
          onPress={() => Linking.openURL('https://www.dominicos.org/predicacion/evangelio-del-dia')}
          activeOpacity={0.8}
          style={[t.linkBtn, { borderTopWidth: 0, borderBottomWidth: 0.5, borderBottomColor: border }]}
        >
          <IcoLink c={Colors.brand.primary} size={16} />
          <View style={{ flex: 1 }}>
        ...
        <TouchableOpacity
          onPress={() => Linking.openURL('https://www.vaticannews.va/es/evangelio-de-hoy.html')}
          activeOpacity={0.8}
      ...
      <TouchableOpacity
        onPress={onLogout}
        style={[t.logoutBtn, { backgroundColor: surface, borderColor: Colors.liturgical.red + '35' }]}
        activeOpacity={0.7}
      >
        <View style={[t.logoutIcon, { backgroundColor: Colors.liturgical.red + '15' }]}>
          <IcoPower c={Colors.liturgical.red} size={17} />
        </View>
        <Text style={[t.logoutText, { color: Colors.liturgical.red }]}>Cerrar sesión</Text>
      </TouchableOpacity>
...
const s = StyleSheet.create({
  ...
  heroPhone: {
    ...
    fontSize: 21, lineHeight: 26, marginBottom: 10,
  },
  heroBadge: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
    paddingHorizontal: 12, paddingVertical: 5,
    borderRadius: 999, borderWidth: 1, marginBottom: 0,
  },
  ...
  statValue: { fontFamily: 'CormorantGaramond-SemiBoldItalic', fontSize: 26, lineHeight: 30 },
  statLabel: { fontSize: 10, fontWeight: '600', letterSpacing: 1, textTransform: 'uppercase', marginTop: 2 },
...
const t = StyleSheet.create({
  ...
  themeRow: {
    ...
    borderBottomWidth: 0.5, minHeight: 52,
  },
  themeIconWrap: {
  ...
  chip: { paddingHorizontal: 12, paddingVertical: 7, borderRadius: 999, borderWidth: 1.2 },
  ...
  // ElevenLabs
  premiumBanner: {
    marginHorizontal: 20, borderRadius: 16, borderWidth: 1.5, padding: 16, gap: 14,
  },
  ...
  premiumTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 4, flexWrap: 'wrap' },
  ...
  credInput: {
    fontSize: 14, flex: 1, paddingVertical: 0,
    borderBottomWidth: 0,
  },
  eyeBtn: { padding: 4 },
  ...
  logoutIcon: { width: 32, height: 32, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
